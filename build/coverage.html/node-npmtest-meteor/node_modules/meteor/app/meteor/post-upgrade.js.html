...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-meteor/node_modules/meteor/app/meteor/post-upgrade.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-meteor/node_modules/meteor/app/meteor/post-upgrade.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-meteor/node_modules/meteor/app/meteor/</a> &#187; post-upgrade.js</div>
</div>
<div class="body">
...
&nbsp;
  <span class="missing-if-branch" title="else path not taken" >E</span>if (fs.existsSync(changelogPath)) {
...
&nbsp;
    _.each(changelogSections, function (section) {
      ...
      <span class="missing-if-branch" title="if path not taken" >I</span>if (m &amp;&amp; m[1] === VERSION) {
<span class="cstat-no" title="statement not covered" >        section = section.replace(/^\s+/, '').replace(/\s+$/, '');</span>
<span class="cstat-no" title="statement not covered" >        console.log();</span>
<span class="cstat-no" title="statement not covered" >        console.log(section);</span>
<span class="cstat-no" title="statement not covered" >        console.log();</span>
      }
    });
  }
